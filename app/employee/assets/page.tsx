...
export default function MyAssets() {
    ...
    // Filter assets assigned to current user (Mock ID check)
    // In real app, this would be user.id
    const myAssets = mockAssets.filter(a => a.assignedTo === "1") // Using ID 1 for mock demo
                    ...
                    <div key={asset.id} className="glass p-6 flex flex-col gap-4 relative overflow-hidden group">
                        ...
                        <div className="flex items-start justify-between relative z-10">
                            <div className={cn("w-10 h-10 rounded-lg flex items-center justify-center text-white",
                                asset.type === 'Hardware' ? "bg-blue-500" : "bg-purple-500"
                            )}>
                        ...
                        <div className="mt-auto pt-4 border-t border-[var(--border)] flex justify-between items-center relative z-10">
                            ...
                            <button className="text-[11px] text-[var(--red)] flex items-center gap-1 hover:underline">
